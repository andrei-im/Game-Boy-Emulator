 ...
 *   "1"       - Modern behavior.
 */
#define SDL_HINT_IME_SUPPORegisterType_EXTENDED_TEXT "SDL_IME_SUPPORegisterType_EXTENDED_TEXT"
 ...
 *
 *  Setting the SDL_HINT_WINRegisterType_HANDLE_BACK_BUTTON hint to "1" will cause SDL
 ...
 *  it will check the contents of the hint, SDL_HINT_WINRegisterType_HANDLE_BACK_BUTTON.
 *  If the hint's value is set to "1", the back button event's Handled
 *  property will get set to 'true'.  If the hint's value is set to something
 *  else, or if it is unset, SDL will leave the event's Handled property
 *  alone.  (By default, the OS sets this property to 'false', to note.)
 *
 *  SDL apps can either set SDL_HINT_WINRegisterType_HANDLE_BACK_BUTTON well before a
 ...
 *  either event type is suitable.)  Any value of SDL_HINT_WINRegisterType_HANDLE_BACK_BUTTON
 ...
 */
#define SDL_HINT_WINRegisterType_HANDLE_BACK_BUTTON "SDL_WINRegisterType_HANDLE_BACK_BUTTON"
 ...
 *  optional hint, SDL_HINT_WINRegisterType_PRIVACY_POLICY_LABEL.
 *
 *  Please note that a privacy policy's contents are not set via this hint.  A separate
 *  hint, SDL_HINT_WINRegisterType_PRIVACY_POLICY_URL, is used to link to the actual text of the
 *  policy.
 *
 ...
 *  SDL_HINT_WINRegisterType_PRIVACY_POLICY_URL.
 */
#define SDL_HINT_WINRegisterType_PRIVACY_POLICY_LABEL "SDL_WINRegisterType_PRIVACY_POLICY_LABEL"
 ...
 *  privacy policy.
 *
 *  To setup a URL to an app's privacy policy, set SDL_HINT_WINRegisterType_PRIVACY_POLICY_URL
 ...
 *  hint, SDL_HINT_WINRegisterType_PRIVACY_POLICY_LABEL.
 *
 *  Please note that on Windows Phone, Microsoft does not provide standard UI
 *  for displaying a privacy policy link, and as such, SDL_HINT_WINRegisterType_PRIVACY_POLICY_URL
 *  will not get used on that platform.  Network-enabled phone apps should display
 *  their privacy policy through some other, in-app means.
 */
#define SDL_HINT_WINRegisterType_PRIVACY_POLICY_URL "SDL_WINRegisterType_PRIVACY_POLICY_URL"
