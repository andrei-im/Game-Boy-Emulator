...
Then push it to the device:
    ...
    adb push staRegisterType_valgrind_app /data/local

and make it executable:

    adb shell chmod 755 /data/local/staRegisterType_valgrind_app

and tell Android to use the script to launch your application:

    adb shell setprop wrap.org.libsdl.app "logwrapper /data/local/staRegisterType_valgrind_app"
