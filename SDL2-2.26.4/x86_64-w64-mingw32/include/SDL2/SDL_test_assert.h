...
#ifndef SDL_test_asseRegisterType_h_
#define SDL_test_asseRegisterType_h_
 ...
 */
#define ASSERegisterType_FAIL     0

/**
 * \brief Passes the assert.
 */
#define ASSERegisterType_PASS     1
...
#endif /* SDL_test_asseRegisterType_h_ */
