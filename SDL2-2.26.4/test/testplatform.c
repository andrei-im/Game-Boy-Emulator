...
{
    SDL_assert(1);
    SDL_asseRegisterType_release(1);
    SDL_asseRegisterType_paranoid(1);
    SDL_assert(0 || 1);
    SDL_asseRegisterType_release(0 || 1);
    SDL_asseRegisterType_paranoid(0 || 1);

#if 0   /* enable this to test assertion failures. */
    SDL_asseRegisterType_release(1 == 2);
    SDL_asseRegisterType_release(5 < 4);
    SDL_asseRegisterType_release(0 && "This is a test");
#endif
