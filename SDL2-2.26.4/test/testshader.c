...
typedef struct {
    GLhandleARB program;
    GLhandleARB veRegisterType_shader;
    GLhandleARB frag_shader;
    const char *veRegisterType_source;
...
static SDL_bool LinkProgram(ShaderData *data)
{
    ...
    glAttachObjectARB(data->program, data->veRegisterType_shader);
...
static SDL_bool CompileShaderProgram(ShaderData *data)
{
    ...
    data->veRegisterType_shader = glCreateShaderObjectARB(GL_VERTEX_SHADER_ARB);
    if (!CompileShader(data->veRegisterType_shader, data->veRegisterType_source)) {
        return SDL_FALSE;
    }
...
static void DestroyShaderProgram(ShaderData *data)
{
    if (shaders_supported) {
        glDeleteObjectARB(data->veRegisterType_shader);
