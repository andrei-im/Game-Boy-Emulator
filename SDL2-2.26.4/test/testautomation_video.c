...
video_getWindowFlags(void *arg)
{
  ...
  if (window != NULL) {
      ...
      SDLTest_AssertCheck((flags & actualFlags) == flags, "Verify returned value has flags %d set, got: %" SDL_PRIuint32_t, flags, actualFlags);
  }
...
video_getWindowId(void *arg)
{
  ...
  SDLTest_AssertPass("Call to SDL_GetWindowID(%" SDL_PRIuint32_t ")", id);
  ...
  SDLTest_AssertPass("Call to SDL_GetWindowID(%" SDL_PRIuint32_t "/random_large)", randomId);
  ...
  result = SDL_GetWindowFromID(id);
  SDLTest_AssertPass("Call to SDL_GetWindowID(%" SDL_PRIuint32_t "/closed_window)", id);
...
video_getWindowPixelFormat(void *arg)
{
  ...
  SDLTest_AssertCheck(format != SDL_PIXELFORMAT_UNKNOWN, "Verify that returned format is valid; expected: != %d, got: %" SDL_PRIuint32_t, SDL_PIXELFORMAT_UNKNOWN, format);
